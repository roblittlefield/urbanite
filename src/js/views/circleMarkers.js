...
export function addCircleMarkers(data, callsLayer, respCircleLayer) {
  ...
  <div>
    ...
    <img src="https://cdn.akamai.steamstatic.com/steam/apps/1063730/header.jpg?t=1695753023" alt="Game" style="width: 176px; height: 70px; position: absolute; left: 50%; transform: translateX(-50%);  top: -70px;" class="affiliate-popup">
    </a>
